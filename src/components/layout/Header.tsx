...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="h-16 border-b border-white/10 bg-[#090b12]/90 backdrop-blur-md sticky top-0 z-40 px-6 flex items-center justify-between">
      ...
      <div className="flex items-center space-x-4">
        <button
          ...
          title="Return to empty creative space"
        >
        ...
        <div className="flex items-center space-x-2.5">
          <h2 className="text-sm font-serif font-semibold text-slate-100 truncate max-w-[220px] md:max-w-md">
            {world.name}
          </h2>
      ...
      {/* Right: World Switcher, Memory Notes, Narrative Log, API Badge */}
      <div className="flex items-center space-x-2 sm:space-x-3">
        {/* Turn indicator */}
        <span className="text-[11px] font-mono text-slate-400 bg-white/[0.03] px-2.5 py-1 rounded border border-white/5 hidden lg:inline">
        ...
        <button
          ...
          className="px-3 py-1.5 rounded-lg bg-white/[0.03] hover:bg-white/[0.07] border border-white/10 text-xs font-medium text-slate-300 transition-colors flex items-center space-x-1.5"
        ...
        <button
          ...
          className="px-3 py-1.5 rounded-lg bg-white/[0.03] hover:bg-white/[0.07] border border-white/10 text-xs font-medium text-slate-300 transition-colors flex items-center space-x-1.5 relative"
        >
        ...
        <div className="relative">
          <button
            ...
            className="px-3 py-1.5 rounded-lg bg-indigo-600/20 hover:bg-indigo-600/30 border border-indigo-500/30 text-xs font-medium text-indigo-200 transition-colors flex items-center space-x-1.5"
          >
            <Layers className="w-3.5 h-3.5" />
            <span className="hidden sm:inline">Switch World</span>
